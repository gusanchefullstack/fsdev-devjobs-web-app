# Planning
- Create a plan for the project, list activities and allow me to validate it. 
- Use the content of the body in @index-source.html as source text (if exist)
...
# Architecture
- Implement the project using HTML/CSS and Reactjs 19 with Typescript.
